...
public class JwtAuthFilter extends OncePerRequestFilter {
    ...
    public JwtAuthFilter(JwtUtil jwtUtil, UserDetailsService userDetailsService, CustomAuthService customAuthService) {
    ...
    protected void doFilterInternal(@Nonnull HttpServletRequest request,
        ...
        if (StringUtils.hasText(token) && jwtUtil.validateToken(token, customAuthService)) {
